Shader "Unlit/StarField"
{
    Properties
    {
        ...
        _Iteration("Inner Iteration", Range(1,20))=13
        ...
        _Tile("Tile", Range(0,5))=1
        _Speed("Speed", Range(0,1))=0.5
        _DirectionX("DirectionX", Range(0,1))=0.5
        _DirectionY("DirectionY", Range(0,1))=0.5
        _Brightness("Brightness", Range(0.0, 0.01))=0.0015
        _DistFading("Fading", Range(0.1,1))=0.73

        _Darkness("Darkness", Range(0.1,1))=0.5
