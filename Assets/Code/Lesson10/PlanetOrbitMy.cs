...
namespace Mechanics
{
    public class PlanetOrbitMy : NetworkMovableObject
    {
        ...
        private void Start()
        {
            if (isServer)
            {
                ...
                _aroundPoint = FindObjectOfType<CenterSystem>().transform;
            }
        ...
        protected override void HasAuthorityMovement()
        {
            ...
            transform.up);
            _currentAng += circleRadians * _circleInSecond * Time.deltaTime;
            SendToServer();
        }
